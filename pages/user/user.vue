		 ...
		 @touchstart="coverTouchstart" @touchmove="coverTouchmove" @touchend="coverTouchend">
			...
			<view class="success-section">
					...
					<view class="cu-list grid col-4 no-border">
						<view class="cu-item" v-for="(item,index) in achievementList" :key="index" @click="navTo(item.page)">
			...
			<view class="success-section solid-bottom">
					<view class="cu-bar bg-white solid-bottom">
						<view class="action">
		...
		data() {
			return {
				...
				achievementList: [{
					...
					cuIcon: 'calendar',
					color: 'yellow',
					page: '/pages/statistics/calendar',
					badge: 0,
					name: '打卡日历',
					count: '1'
				}, {
